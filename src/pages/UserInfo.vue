<template>
  ...
  <hr />
    ...
    <!-- <router-link :to="{name : 'userSearch'}"><button @onclick="fetchData()">이전</button></router-link>
    <router-link :to="{name : 'userList'}"><button @onclick="fetchData()">새로고침</button></router-link>
    <router-link :to="{name : 'postListShow'}"><button @onclick="fetchData()">다음</button></router-link> -->
  <hr />
</template>
